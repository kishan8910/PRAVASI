...
<body>
	<header id="header">
		<hgroup>
			...
			<?php
				if($_SESSION['user_id'] || $_SESSION['user_email'] || $_SESSION['user_first_name'] || $_SESSION['user_aadhar_no'])
				{										
	...
	<section id="secondary_bar">
		<div class="user">
			...
			<?php
				if($_SESSION['user_id'] || $_SESSION['user_email'] || $_SESSION['user_first_name'] || $_SESSION['user_aadhar_no'])
				{					
					// echo "<a href=\"user.php\">Welcome ".$_SESSION['user_first_name']."!</a> ";
				}	
			?>		
			</p>			
		</div>
		<div class="breadcrumbs_container">
			...
			<?php
				if($_SESSION['user_id'] || $_SESSION['user_email'] || $_SESSION['user_first_name'] || $_SESSION['user_aadhar_no'])
				{					
					// echo "<a href=\"user.php?u=cp&b=cpf\">Change Password</a> ";
				}	
			?>		
			</p>
			</div>
