...
if( $_SERVER['REQUEST_METHOD'] == "GET")
{
	...
	{
		unlink("../$imgurl");	
		echo "<img src=\"../libcommon/images/noImage.jpeg\" style=\"width:75px; height:100px; float:left;\" /> 
				<div id=\"upload_image\">
				<input name=\"upload_image\" class=\"btn\" type=\"button\" value=\"Upload Image\" style=\"margin:40px 0 0 30px;\" />
				</div>				
				<span id=\"file\"></span>";
	}
	else 
