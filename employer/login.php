...
if( $_SERVER['REQUEST_METHOD'] == "POST") {
	...
	$sql = "SELECT id, name, password , email FROM admin WHERE email=\"$adminEmail\" AND password=\"".md5($adminPassword)."\"";	
	...
	if(sql_num_rows($result)) {
		...
		$_SESSION['admin_password'] = $row[2];
		$_SESSION['admin_email'] = $row[3];
		// $_SESSION['admintypeID'] = $row[5];
